...
/*
 ...
 | 
 */
defined('WORKING_DIR') OR define('WORKING_DIR', '/xetool/api/v1/');
...
*/
defined('ASSETS_PATH_W')                OR define('ASSETS_PATH_W', $_SERVER['DOCUMENT_ROOT'] . '/xetool/assets/');
defined('ASSETS_PATH_R')                OR define('ASSETS_PATH_R', $domainUrl . '/xetool/assets/');
...
defined('WC_API_URL')                   OR define('WC_API_URL', 'http://3.18.103.242/stores/woocommerce/');
defined('WC_API_CK')                    OR define('WC_API_CK', 'ck_59d47ee2b786089065c9aab209a4973dfb6bfa8b');
defined('WC_API_CS')                    OR define('WC_API_CS', 'cs_e3732fbe40dc79ed9df1b99f44e658687911af59');
